...
def convert(cfg):
    ...
    src_wav_paths = get_flac_files('../../../Dataset/VCTK-Corpus/wav48_silence_trimmed/p238')
    ...
    tar1_wav_paths  = get_flac_files('../../../Dataset/VCTK-Corpus/wav48_silence_trimmed/p243')
    tar2_wav_paths  = get_flac_files('../../../Dataset/VCTK-Corpus/wav48_silence_trimmed/p294')
    ...
    cmd = ['parallel-wavegan-decode', '--checkpoint', \
           '/home/eng/s/sxh200008/VQMIVC/vocoder/checkpoint-3000000steps.pkl', \
